...
class QRScanner:
    def __init__(self) -> None:
        self.img_granted = cv2.imread("app/static/imgs/access-granted.jpg", cv2.IMREAD_COLOR) 
        self.img_denied = cv2.imread("app/static/imgs/access-denied.jpg", cv2.IMREAD_COLOR)   
